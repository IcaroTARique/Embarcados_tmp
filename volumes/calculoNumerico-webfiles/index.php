	...
	<div class="container">
		<div id="base">
			...
			<div id="forms">
				...
				<p>O <b>MEDIDOR INTELIGENTE</b> é uma ferramenta que possibilita ao usuário ou cliente manter um controle de seu consumo de modo prático e
				fácil a partir de nossa interface simples e igualmente inteligente. O <b>MEDIDOR INTELIGENTE</b> é uma solução tecnológica atual que trabalha com
				com dados em tempo real que tem por objetivo, além de fazer o monitoramento dos dados, cria uma consciência ecológicamente correta na mente dos
				nossos clientes.</p>
